...
//use App\Http\Controllers\ChrevadminController;
 ...
 */
 ...
 // CATEGORIAS
 Route::get('/categorias', [CategoriaController::class, 'ver'])->name('categorias');
Route::view('/categorias/create', 'paytrack/categorias/create', ['page_title' => 'Dashboard', 'page_desciption' => 'Some description for the page', 'logo' => "images/logo.png", 'logoText' => "images/logo-text.png", "action" => 'dashboard_1'])->name('categorias.crear');
Route::post('categorias/create', [CategoriaController::class, 'create'])->name('categorias.save');

// BOLSA
Route::get('/bolsa', [BolsaController::class, 'ver'])->name('bolsas');
Route::view('/bolsa/create', 'paytrack/bolsa/create', ['page_title' => 'Dashboard', 'page_desciption' => 'Some description for the page', 'logo' => "images/logo.png", 'logoText' => "images/logo-text.png", "action" => 'dashboard_1'])->name('bolsa.crear');
Route::post('bolsa/create', [BolsaController::class, 'save'])->name('bolsa.save');
...
Route::post('/gastos/save', [GastoController::class, 'save'])->name('gastos.save');

// DASHBOARD
Route::get('/paytrack', [BolsaController::class, 'dashboard'])->name('paytrack.dashboard');
...
Route::get('/programado', [ProgramadoController::class, 'programados']);

Route::view('TareaSanti', 'tareas/index', ['page_title' => 'Dashboard', 'page_desciption' => 'Some description for the page', 'logo' => "images/logo.png", 'logoText' => "images/logo-text.png", "action" => 'dashboard_1' ]);


Route::get('/', 'App\Http\Controllers\ChrevadminController@dashboard_1');
//Route::get('/prom', 'App\Http\Controllers\ChrevadminController@programados');
