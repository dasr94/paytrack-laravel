            ...
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Paytrack</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="{!! url('/categorias'); !!}">Categorias</a></li>
							<li><a href="{!! url('/categorias/create'); !!}">Categorias Crear</a></li>
							<li><a href="{!! url('/bolsa'); !!}">Bolsa</a></li>
							<li><a href="{!! url('/bolsa/create'); !!}">Bolsa Crear</a></li>
							<li><a href="{!! url('/gastos'); !!}">Gastos</a></li>
							<li><a href="{!! url('/gastos/crear'); !!}">Gastos Crear</a></li>
							<li><a href="{!! url('/paytrack'); !!}">Dashboard</a></li>
